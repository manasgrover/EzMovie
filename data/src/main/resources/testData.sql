...
insert into tbl_availabilty (audi_id, time_slot_id, seat_number, date, available, booking_id,movie) values (1, 1, 1, 1510043874033, true, null,'don'), (1, 1, 2, 1510043874033, true, null,'don'), (1, 1, 4, 1510043874033, true, null,'don');
